...
def run(args):
    ...
    path = args.directory
    filename = args.search_output.split('.')[0]
    ...
    search_strings_df['GeneClass'] = search_strings_df['GeneClass'].str.title()  # convert to proper format
    ...
    #cols_to_keep = list(sums_df[sums_df['sum'] >= required_min]['variable'])
